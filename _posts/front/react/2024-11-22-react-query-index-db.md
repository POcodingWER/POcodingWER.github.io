...
![](/img/post/2024/1122/react-query.gif){: #magnific width="2270" height="1364"}
...
![](/img/post/2024/1122/index1.gif){: #magnific width="2270" height="1364"}

> `REFRESH_TIME`넣어 5초마다 리프레시 되는것을 확인하였고 캐시된 데이터가 있으면 캐시된 데이터를 사용하는것을 확인

![](/img/post/2024/1122/index2.gif){: #magnific width="2270" height="1364"}
