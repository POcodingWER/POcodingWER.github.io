...
catalog: true
header-mask: 0.4
header-img: "img/post/2025/02/virtual_dom.webp"
#
# sitemap:
...
![](/img/post/2025/02/diffing_1.gif){: #magnific width="779" height="218"}
...
![](/img/post/2025/02/diffing_2.gif){: #magnific width="779" height="218"}
이 경우에는 요소 유형이 변경되지 않으므로 부모 요소가 아닌 요소만 다시 렌더링되는 것을 볼 수 있습니다( `<p>`로 유지됨 `<p>`).
이렇게 전체적인 과정이 이루어지며, React는 이 모든 과정을 자동으로 최적화하여 처리합니다! 🎉

### 2. prop key 기반 업데이트

![](/img/post/2025/02/diffing_3.gif){: #magnific width="779" height="260"}
...
![](/img/post/2025/02/diffing_4.gif){: #magnific width="779" height="258"}
