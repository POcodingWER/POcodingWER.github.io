...
mac 원인은 key체인 접급
![](/img/post/2024/0826/1.png){: #magnific width="1178" height="868"}
![](/img/post/2024/0826/2.png){: #magnific width="1722" height="1034"}
![](/img/post/2024/0826/3.png){: #magnific width="1046" height="684"}
...
2. userA로 GitHub에 로그인 후 오른쪽 상단의 프로필 사진을 클릭한 후 Settings 메뉴를 선택합니다.
   ![](/img/post/2024/0826/4.png){: #magnific width="634" height="1478"}

3. 왼쪽 사이드바 메뉴에서 “SSH and GPG keys” 를 선택한 후 오른쪽 상단의 “New SSH key” 단추를 클릭합니다.
   ![](/img/post/2024/0826/5.png){: #magnific width="844" height="1418"}
...
4. “Title” 입력칸에 등록할 공개키를 설명할 수 있는 문구를 입력 합니다. 예로 notebook-userA 처럼 각 노트북 , 데스크탑 등 사용하는 컴퓨터를 구분할 수 있도록 작성하면 편리합니다. “key” 필드에는 복사해둔 공개키를 붙여놓은 후 아래 “Add SSH key” 단추를 클릭합니다.
   ![](/img/post/2024/0826/6.png){: #magnific width="810" height="852"}
...
![](/img/post/2024/0826/7.png){: #magnific width="810" height="852"}
