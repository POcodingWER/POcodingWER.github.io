...
catalog: true
header-mask: 0.4
header-img: "img/post/2024/1030/1.webp"
#
# sitemap:
...
1. 프로젝트부터 만들자
   ![](/img/post/2024/1030/1.webp){: #magnific width="3002" height="1558"}
1. 새 프로젝트 클릭
   ![](/img/post/2024/1030/3.webp){: #magnific width="1594" height="1238"}
1. 이름 입력 만들기
   ![](/img/post/2024/1030/4.webp){: #magnific width="2190" height="1294"}
1. 햄버거 누르고 -> IAM 및 관리자 -> 서비스 계정 클릭
   ![](/img/post/2024/1030/5.webp){: #magnific width="1266" height="1568"}
1. 서비스 계정 만들기
   ![](/img/post/2024/1030/2.webp){: #magnific width="3016" height="772"}
1. 이것저것 적고 완료
   ![](/img/post/2024/1030/6.webp){: #magnific width="1210" height="1298"}
   ![](/img/post/2024/1030/7.webp){: #magnific width="2492" height="716"}
1. 키 만들기
   ![](/img/post/2024/1030/8.webp){: #magnific width="1926" height="930"}
1. 키 만들기 클릭 **파일이 만들어지는데 이거 키중요하니깐 꼭간직하고 잊어버리지말기**
   ![](/img/post/2024/1030/9.webp){: #magnific width="1798" height="994"}
   `**파일이 만들어지는데 이거 키중요하니깐 꼭간직하고 잊어버리지말기**`
1. indexing api 검색 후 활성화
   ![](/img/post/2024/1030/10.webp){: #magnific width="2716" height="1040"}
   ![](/img/post/2024/1030/11.webp){: #magnific width="1850" height="1274"}
...
1. 설정 -> 사용자 및 권한 -> 사용자추가 -> 위에 1-6번에서만든 id넣어주고 (`만들때 소유주로만들어주셈`)
   ![](/img/post/2024/1030/12.webp){: #magnific width="2758" height="1358"}
...
![](/img/post/2024/1030/13.webp){: #magnific width="1258" height="1130"}
...
![](/img/post/2024/1030/14.webp){: #magnific width="1302" height="264"}
