...
![](/img/post/2024/0810/1.png){: #magnific width="1436" height="656"} 1.인스톨눌러서 진행
![](/img/post/2024/0810/2.png){: #magnific width="910" height="1248"} 2.인스톨 눌러서

### 2. 설정

[《utterances 설정》](https://utteranc.es/)
![](/img/post/2024/0810/3.png){: #magnific width="476" height="1224"}
...
![](/img/post/2024/0810/4.png){: #magnific width="1278" height="674"}
![](/img/post/2024/0810/5.png){: #magnific width="1882" height="1440"} 2.1에서 설정한 레파지토리에 이슈로 남아있는다.

### 4. 이메일 알림 설정

github 설정한(repository) setting -> email notifications
-> 이메일 설정하면 된다.
![](/img/post/2024/0810/6.png){: #magnific width="2358" height="1458"}
