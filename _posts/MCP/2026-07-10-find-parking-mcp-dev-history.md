...
catalog: true
header-mask: 0.4
header-img: "img/post/2026/07/find_parking_mcp_under_review.webp"
...
![](/img/post/2026/07/playmcp_tesla_supercharger_demo.webp){: #magnific width="534" height="1024"}
...
![](/img/post/2026/07/kc_mcp_server_register.webp){: #magnific width="1802" height="1258"}
...
![](/img/post/2026/07/kc_mcp_server_active.webp){: #magnific width="2242" height="1060"}
...
![](/img/post/2026/07/playmcp_register_form.webp){: #magnific width="1534" height="1452"}

등록이 완료되면 MCP 설명·대화 예시·Endpoint가 아래처럼 채워집니다.

![](/img/post/2026/07/playmcp_register_detail.webp){: #magnific width="1052" height="542"}
...
![](/img/post/2026/07/find_parking_mcp_under_review.webp){: #magnific width="2264" height="872"}
...
![](/img/post/2026/07/agentic_player_10_schedule.webp){: #magnific width="559" height="666"}
