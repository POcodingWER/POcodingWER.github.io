...
![](/POcodingWER_Blog/img/post/0810/1.png) 1.인스톨눌러서 진행
![](/POcodingWER_Blog/img/post/0810/2.png) 2.인스톨 눌러서

### 2. 설정

[《utterances 설정》](https://utteranc.es/)
![](/POcodingWER_Blog/img/post/0810/3.png)
...
![](/POcodingWER_Blog/img/post/0810/4.png)
![](/POcodingWER_Blog/img/post/0810/5.png) 2.1에서 설정한 레파지토리에 이슈로 남아있는다.

### 4. 이메일 알림 설정

github 설정한(repository) setting -> email notifications
-> 이메일 설정하면 된다.
![](/POcodingWER_Blog/img/post/0810/6.png)
