...
catalog: true
header-mask: 0.4
header-img: "img/post/2024/0819/cloud_front.webp"
#
# sitemap:
...
1. 무효화 탭 클릭
1. 무효화 생성 버튼 클릭
   ![](/img/post/2024/0819/1.webp){: #magnific width="2334" height="630"}
1. 객체경로에 wildcard 입력 `\*` 전체경로
   ![](/img/post/2024/0819/2.webp){: #magnific width="1724" height="868"}
