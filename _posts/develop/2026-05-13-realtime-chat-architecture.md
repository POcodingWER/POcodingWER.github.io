...
catalog: true
header-mask: 0.4
header-img: "img/post/2026/05/chat_architecture.webp"
...
![P2P vs Server 비교](/img/post/2026/05/chat_p2p_vs_server.webp){: width="1536" height="1024"}
...
![Socket.IO Room 개념](/img/post/2026/05/chat_room_concept.webp){: width="1536" height="1024"}
...
![알림 분기 처리 플로우](/img/post/2026/05/chat_notification_flow.webp){: width="1536" height="1024"}
