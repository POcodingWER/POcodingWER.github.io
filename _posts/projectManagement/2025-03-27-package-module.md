...
catalog: true
header-mask: 0.4
header-img: "img/post/2025/03/packages/npm.webp"
#
# sitemap:
...
![폴더구조](/img/post/2025/03/packages/folder.webp){: width="269" height="197"}
...
1.eslint package
![패키지 구조 예시](/img/post/2025/03/packages/package_1.webp){: width="1560" height="1292"}
2.prettier package
![패키지 구조 예시](/img/post/2025/03/packages/prettier.webp){: width="1544" height="1006"}
...
![토큰 생성](/img/post/2025/03/packages/token.webp){: width="1612" height="1188"}
...
![npm login](/img/post/2025/03/packages/login.webp){: width="976" height="184"}
...
![npm publish](/img/post/2025/03/packages/publish.webp){: width="1460" height="574"}
![npm publish](/img/post/2025/03/packages/complete.webp){: width="3014" height="1008"}
...
![패키지 다운 확인](/img/post/2025/03/packages/install.webp){: width="1928" height="1562"}
